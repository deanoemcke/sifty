...
describe("computeFilterReason", () => {
  ...
  it('returns "price" when listing price is below minPrice', () => {
    expect(
      computeFilterReason(makeListing({ price: 900, priceDisplay: "$900" }), {
        ...defaultFilters,
        minPrice: 1000,
      }),
    ).toBe("price");
  ...
  it("returns null when listing price equals minPrice", () => {
    expect(
      computeFilterReason(makeListing({ price: 1000, priceDisplay: "$1,000" }), {
        ...defaultFilters,
        minPrice: 1000,
      }),
    ).toBeNull();
  ...
  it('returns "price" when listing price exceeds maxPrice', () => {
    expect(
      computeFilterReason(makeListing({ price: 2001, priceDisplay: "$2,001" }), {
        ...defaultFilters,
        maxPrice: 2000,
      }),
    ).toBe("price");
  ...
  it("returns null when listing price equals maxPrice", () => {
    expect(
      computeFilterReason(makeListing({ price: 2000, priceDisplay: "$2,000" }), {
        ...defaultFilters,
        maxPrice: 2000,
      }),
    ).toBeNull();
  ...
  it("returns null when price is null (unlisted price bypasses price filter)", () => {
    expect(
      computeFilterReason(makeListing({ price: null, priceDisplay: "Make an offer" }), {
        ...defaultFilters,
        minPrice: 1000,
        maxPrice: 500,
      }),
  ...
  it('returns "price" when price falls outside both min and max range', () => {
    expect(
      computeFilterReason(makeListing({ price: 500, priceDisplay: "$500" }), {
        ...defaultFilters,
        minPrice: 1000,
        maxPrice: 2000,
      }),
  ...
  it('returns "keyword" when title does not contain required keyword', () => {
    expect(
      computeFilterReason(makeListing({ title: "MacBook Pro M1" }), {
        ...defaultFilters,
        keywords: ["m2"],
      }),
    ).toBe("keyword");
  ...
  it("returns null when title contains all required keywords (case-insensitive)", () => {
    expect(
      computeFilterReason(makeListing({ title: 'MacBook Pro M2 14"' }), {
        ...defaultFilters,
        keywords: ["M2", "14"],
      }),
    ).toBeNull();
  ...
  it('returns "keyword" when title contains only some required keywords', () => {
    expect(
      computeFilterReason(makeListing({ title: "MacBook Pro M2" }), {
        ...defaultFilters,
        keywords: ["m2", "14"],
      }),
    ).toBe("keyword");
  ...
  it('returns "keyword" when title matches an exclude keyword', () => {
    expect(
      computeFilterReason(makeListing({ title: "MacBook Pro - faulty screen" }), {
        ...defaultFilters,
        excludeKeywords: ["faulty"],
      }),
    ).toBe("keyword");
  });
  ...
  it("returns null when excludeKeywords is empty", () => {
    expect(
      computeFilterReason(makeListing({ title: "MacBook Pro - faulty" }), {
        ...defaultFilters,
        excludeKeywords: [],
      }),
    ).toBeNull();
  ...
  it("returns null when listing has no fulfillment data regardless of shipping filter", () => {
    expect(
      computeFilterReason(makeListing({ fulfillment: undefined }), {
        ...defaultFilters,
