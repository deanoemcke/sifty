...
describe("getWorktreeLabel", () => {
  ...
  it("returns the directory basename for a numbered worktree", () => {
    expect(getWorktreeLabel("/Users/deanoemcke/Projects/sifty-webapp.worktrees/sifty-webapp1")).toBe("sifty-webapp1");
    expect(getWorktreeLabel("/Users/deanoemcke/Projects/sifty-webapp.worktrees/sifty-webapp3")).toBe("sifty-webapp3");
  });

  it("ignores trailing slashes in the path", () => {
    expect(getWorktreeLabel("/Users/deanoemcke/Projects/sifty-webapp.worktrees/sifty-webapp2/")).toBe("sifty-webapp2");
  });
});
